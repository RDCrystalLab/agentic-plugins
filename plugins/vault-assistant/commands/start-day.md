---
allowed-tools: Bash(date:*), Bash(ls:*), Read, Write, Edit
...
1. Yesterday's unfinished `[ ]` items tagged as carry-over or marked urgent
2. Current weekly report's `## In Progress / Carry Over` items
3. Current monthly Objectives in 🔄 In Progress / ⚠️ Blocked status
