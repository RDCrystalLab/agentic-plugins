...
description: "Use when building or maintaining a personal LLM-powered knowledge base. Triggers: ingesting sources into a wiki, querying wiki knowledge, linting wiki quality, 'add to wiki', 'what do I know about', any mention of 'LLM wiki' or 'Karpathy wiki', 以及中文觸發詞：『加入知識庫』、『匯入到 wiki』、『我對 X 知道什麼』、『查詢知識庫』、『整理知識庫』、『檢查 wiki』、『我的 wiki』、『個人知識庫』、『LLM 知識庫』、『Karpathy wiki』等。"
---
